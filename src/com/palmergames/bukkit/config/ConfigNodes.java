...
public enum ConfigNodes {
	...
	GNATION_SETTINGS_NATIONS_CAN_BE_PUBLIC_OR_OPEN(
		"global_nation_settings.can_nations_be_public_or_open",
		"false",
		"# If set to true, nations may toggle both public or open."
	),
